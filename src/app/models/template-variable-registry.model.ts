...
export const TEMPLATE_VARIABLES: TemplateVariableDefinition[] = [
  ...
  { group: 'Company', path: 'company.address.building', label: 'Company building' },
  { group: 'Company', path: 'company.address.line1', label: 'Company address line 1' },
  { group: 'Company', path: 'company.address.line2', label: 'Company address line 2' },
  { group: 'Company', path: 'company.address.suburb', label: 'Company address suburb' },
  { group: 'Company', path: 'company.address.city', label: 'Company address city' },
  { group: 'Company', path: 'company.address.province', label: 'Company address province' },
  { group: 'Company', path: 'company.address.postalCode', label: 'Company address postal code' },
  { group: 'Company', path: 'company.address.country', label: 'Company address country' },
  ...
  { group: 'Client', path: 'client.title', label: 'Client title', docxKey: 'client_title' },
  ...
  { group: 'Client', path: 'client.address.building', label: 'Client building', docxKey: 'client_building' },
  ...
  { group: 'Client', path: 'client.address.city', label: 'Client city', docxKey: 'client_city' },
  { group: 'Client', path: 'client.address.province', label: 'Client province', docxKey: 'client_province' },
  { group: 'Client', path: 'client.address.postalCode', label: 'Client postal code', docxKey: 'client_postal_code' },
  { group: 'Client', path: 'client.address.country', label: 'Client country', docxKey: 'client_country' },
